...
public class Player {
    ...
    public void attack(Player opponent) {
        ...
        System.out.println(this.name + " attacks and rolls die. Die roll: " + attackRoll);
        System.out.println(opponent.getName() + " defends and rolls die. Die roll: " + defenseRoll);
        ...
        if (damage > defense) {
            ...
            System.out.println(opponent.getName() + " health reduced by " + excessDamage + " to " + opponent.getHealth());
            System.out.println();
